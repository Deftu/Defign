...
<svg {width} {height} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="transform: rotate({direction === "up" ? "180deg" : direction === "left" ? "90deg" : direction === "right" ? "-90deg" : "0deg"})">
